...
public class BeanFactory {
    ...
    static List<String> fieldsAlreadyProcessed = new ArrayList<>(); // 缓存已经进行过依赖注入的信息
    ...
    private static void doAutoWired() {
        ...
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            try {
                doObjectDependency(entry.getValue());
     ...
     */
    private static void doObjectDependency(Object object) throws IllegalAccessException {
        ...
        for (int i = 0; i < declaredFields.length; i++) {
            ...
            if (fieldsAlreadyProcessed.contains(object.getClass().getName() + "." + declaredField.getName())) {
                continue;
            }
            ...
            fieldsAlreadyProcessed.add(object.getClass().getName() + "." + declaredField.getName());

            // 迭代
            doObjectDependency(dependObject);
